...
ToDo.prototype.completeToDo = function () {
  ...
  // Preguntar a Alejandro porque no me da el resultado con un arrow function
}
...
function buildToDos(toDos) {
  // Tu código acá:
  const toDosBuild = toDos.map((toDo, index) => {
...
function displayToDos() {
  ...
  const toDoShell = buildToDos(toDoItems)
  toDoShell.forEach(element => {
